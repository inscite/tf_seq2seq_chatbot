...
from tf_seq2seq_chatbot.lib.ko.seq2seq_wireframe import embedding_attention_seq2seq
...
class Seq2SeqModel(object):
	...
	def step(self, session, encoder_inputs, decoder_inputs, target_weights,
		...
		print("[D] bucket_id: %d | buckets: %s | encoder_size: %d | decoder_size: %d"
			  % (bucket_id, self.buckets[bucket_id], encoder_size, decoder_size))
	...
	def get_batch(self, data, bucket_id):
		...
		print("[D]", "Entering method seq2seq_model.get_batch()")
